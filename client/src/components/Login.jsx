          ...
          {mode === "signup" && (
            <Label label="Full Name">
              <input type="text" name="name" placeholder="Aaron Perez"
                value={form.name} onChange={handleChange} required autoComplete="name" className="themed-input" />
            </Label>
          )}
          <Label label="Email">
            <input type="email" name="email" placeholder="you@example.com"
              value={form.email} onChange={handleChange} required autoComplete="email" className="themed-input" />
          </Label>
          ...
          {mode === "signup" && (
            <Label label="Confirm Password">
              <input type="password" name="confirm" placeholder="Re-enter password"
                value={form.confirm} onChange={handleChange} required autoComplete="new-password" className="themed-input" />
            </Label>
          )}
